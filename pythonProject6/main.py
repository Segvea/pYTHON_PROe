...
bot = telebot.TeleBot('7166636572:AAG1O7ca7_EJEDyi8FaJuvdwfLpDnWIg02w')
# bot = telebot.TeleBot('6678166080:AAGAEhkCxK-Z_qeJQF39kwd29ksib-6vgNc')
cols, rows = 8, 8
...
def get_map_str(map_cell, player):  # получает координаты игрока
    map_str = ""
...
def play_message(message):  # команда плей
